 ...
 * Inventario
 *
 * @ORM\Table(name="inventario", uniqueConstraints={@ORM\UniqueConstraint(name="inventario_pk", columns={"id_inventario"})}, indexes={@ORM\Index(name="descarga_fk", columns={"id_compra"}), @ORM\Index(name="tiene_fk", columns={"id_producto"})})
 * @ORM\Entity
 */
class Inventario
{
